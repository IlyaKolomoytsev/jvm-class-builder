...
DescriptorField::DescriptorField(Type primitiveFieldType, uint8_t arrayDepth) : primitiveFieldType_(primitiveFieldType),
    arrayDepth_(arrayDepth) {
    assert(primitiveFieldType_ != Type::Reference);
}

DescriptorField::DescriptorField(std::string classReference, uint8_t arrayDepth) : primitiveFieldType_(Type::Reference),
    arrayDepth_(arrayDepth),
