...
ConstantFieldref::ConstantFieldref(ConstantClass *classConstant,
                                   ConstantNameAndType *nameAndTypeConstant) : Constant(CONSTANT_Fieldref,
                                                                                   classConstant->getOwner()),
                                                                               class_(classConstant),
